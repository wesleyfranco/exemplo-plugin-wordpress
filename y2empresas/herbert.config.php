...
return [
    ...
    'requires' => [
		...
		__DIR__ . '/app/ListTables/WpListTable.php',
		__DIR__ . '/app/ListTables/listTableEmpresa.php',
		__DIR__ . '/app/ListTables/listTableCategoria.php',
		__DIR__ . '/TwigCustomFunctions.php',
    ],
	...
	/**
	* Quantidade de itens por pagina (Paginacao)
	*/
